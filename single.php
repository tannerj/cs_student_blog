...
<h4>By <b> <?php echo $author=get_post_meta($post->ID, 'author', true) ?> </b> on <b><?php echo mysql2date('j M Y', $page_data->post_date); ?></b> Editor <b><?php echo $editor=get_post_meta($post->ID, 'editor', true) ?> </b></h4>
    <hr class="title"/>
